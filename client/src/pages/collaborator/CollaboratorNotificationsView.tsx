      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-900 pb-5">
        <div>
          ...
          <p className="text-slate-400 mt-1 text-sm">
            Read task assignments, status updates, comment logs, and target reminders.
          </p>
        </div>
        {unreadCount > 0 && (
          <Button
              ...
              <CardContent className="p-4 flex items-start justify-between gap-4">
                ...
                {!notif.isRead && (
                  <Button
                    ...
                    className="h-8 w-8 text-slate-400 hover:text-emerald-400 hover:bg-emerald-950/20 rounded-lg shrink-0 animate-pulse"
                  >
                    <Check size={14} />
                  </Button>
                )}
