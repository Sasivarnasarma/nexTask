        ...
        <div className="flex flex-col gap-6 pt-6">
          ...
          <div className="px-4">
            <div className="w-full flex items-center gap-3 bg-slate-950/40 border border-slate-800/60 p-3 rounded-xl">
              <div
                className={`h-9 w-9 rounded-xl ${avatarBg} text-white flex items-center justify-center font-bold text-base shadow-md shrink-0`}
              >
              ...
              <div className="flex flex-col min-w-0 leading-tight">
                ...
                <span className={`text-xs ${avatarText} mt-0.5 font-medium`}>{displayRole}</span>
              </div>
            </div>
          </div>
