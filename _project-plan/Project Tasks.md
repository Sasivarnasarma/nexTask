...
| T4.3    | **Task Assignment Mail Service** - Create mail templates and event-based triggers to notify users via email when they are assigned or reassigned to a task.                                                                                                             | Member C    | Completed |
